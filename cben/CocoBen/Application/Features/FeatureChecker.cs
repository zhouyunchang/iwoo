...
namespace Cben.Application.Features
{
    ...
    public class FeatureChecker : IFeatureChecker, ITransientDependency
    {
        ...
        public Task<string> GetValueAsync(string name)
        {
            ...
            {
                throw new CbenException("FeatureChecker can not get a feature value by name. TenantId is not set in the ICbenSession!");
            }

            return GetValueAsync(CbenSession.TenantId.Value, name);
        }
