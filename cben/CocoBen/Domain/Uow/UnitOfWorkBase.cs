...
namespace Cben.Domain.Uow
{
    ...
    public abstract class UnitOfWorkBase : IUnitOfWork
    {
        ...
        /// <summary>
        /// Reference to current Cben session.
        /// </summary>
        public ICbenSession CbenSession { protected get; set; }
        ...
        public void Begin(UnitOfWorkOptions options)
        {
            ...
            SetTenantId(CbenSession.TenantId);
        ...
        public IDisposable SetTenantId(int? tenantId)
        {
            ...
            var mustHaveTenantEnableChange = tenantId == null
                ? DisableFilter(CbenDataFilters.MustHaveTenant)
                : EnableFilter(CbenDataFilters.MustHaveTenant);

            var mayHaveTenantChange = SetFilterParameter(CbenDataFilters.MayHaveTenant, CbenDataFilters.Parameters.TenantId, tenantId);
            var mustHaveTenantChange = SetFilterParameter(CbenDataFilters.MustHaveTenant, CbenDataFilters.Parameters.TenantId, tenantId ?? 0);
        ...
        private void PreventMultipleBegin()
        {
            ...
            {
                throw new CbenException("This unit of work has started before. Can not call Start method more than once.");
            }
        ...
        private void PreventMultipleComplete()
        {
            ...
            {
                throw new CbenException("Complete is called before!");
            }
        ...
        private void SetFilters(List<DataFilterConfiguration> filterOverrides)
        {
            ...
            if (CbenSession.TenantId == null)
            {
                ChangeFilterIsEnabledIfNotOverrided(filterOverrides, CbenDataFilters.MustHaveTenant, false);
            }
        }
        ...
        private DataFilterConfiguration GetFilter(string filterName)
        {
            ...
            if (filter == null)
            {
                throw new CbenException("Unknown filter name: " + filterName + ". Be sure this filter is registered before.");
            }
