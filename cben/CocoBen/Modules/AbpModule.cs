...
namespace Cben.Modules
{
    ...
    /// </remarks>
    public abstract class CbenModule
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets a reference to the Cben configuration.
        /// </summary>
        protected internal ICbenStartupConfiguration Configuration { get; internal set; }
        ...
        /// <summary>
        /// Checks if given type is an Cben module class.
        /// </summary>
        /// <param name="type">Type to check</param>
        public static bool IsCbenModule(Type type)
        {
            return
                type.IsClass &&
                !type.IsAbstract &&
                !type.IsGenericType &&
                typeof(CbenModule).IsAssignableFrom(type);
        }
        ...
        public static List<Type> FindDependedModuleTypesRecursivelyIncludingGivenModule(Type moduleType)
        {
            ...
            list.AddIfNotContains(typeof(CbenKernelModule));
            return list;
        }

        private static void AddModuleAndDependenciesResursively(List<Type> modules, Type module)
        {
            if (!IsCbenModule(module))
            {
                throw new CbenInitializationException("This type is not an Cben module: " + module.AssemblyQualifiedName);
            }
