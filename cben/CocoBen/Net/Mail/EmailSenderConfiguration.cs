...
namespace Cben.Net.Mail
{
    ...
    public abstract class EmailSenderConfiguration : IEmailSenderConfiguration
    {
        ...
        /// <summary>
        /// Gets a setting value by checking. Throws <see cref="CbenException"/> if it's null or empty.
        /// </summary>
        ...
        protected string GetNotEmptySettingValue(string name)
        {
            ...
            {
                throw new CbenException(String.Format("Setting value for '{0}' is null or empty!", name));
            }
