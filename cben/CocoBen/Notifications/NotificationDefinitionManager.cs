...
namespace Cben.Notifications
{
    ...
    internal class NotificationDefinitionManager : INotificationDefinitionManager, ISingletonDependency
    {
        ...
        public void Add(NotificationDefinition notificationDefinition)
        {
            ...
            {
                throw new CbenInitializationException("There is already a notification definition with given name: " + notificationDefinition.Name + ". Notification names must be unique!");
            }
        ...
        public NotificationDefinition Get(string name)
        {
            ...
            if (definition == null)
            {
                throw new CbenException("There is no notification definition with given name: " + name);
            }
