...
namespace Cben.Threading.Timers
{
    /// <summary>
    ...
    public class CbenTimer : RunnableBase, ITransientDependency
    {
        /// <summary>
        ...
        public CbenTimer(int period, bool runOnStart = false)
            : this()
        {
            Period = period;
        ...
        public override void Start()
        {
            if (Period <= 0)
            {
                throw new CbenException("Period should be set before starting the timer!");
            }
