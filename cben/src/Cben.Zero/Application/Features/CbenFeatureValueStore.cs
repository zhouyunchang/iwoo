...
namespace Cben.Application.Features
{
    ...
    /// </summary>
    public abstract class CbenFeatureValueStore<TTenant, TUser> : 
        ICbenZeroFeatureValueStore, 
        ...
        where TUser : CbenUser<TUser>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CbenFeatureValueStore{TTenant, TUser}"/> class.
        /// </summary>
        protected CbenFeatureValueStore(
