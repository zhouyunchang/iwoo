...
namespace Cben.Authorization.Roles
{
    ...
    /// </remarks>
    public abstract class CbenRole<TUser> : CbenRoleBase, IFullAudited<TUser>
        where TUser : CbenUser<TUser>
    {
        ...
        /// <summary>
        /// Creates a new <see cref="CbenRole{TTenant,TUser}"/> object.
        /// </summary>
        public CbenRole()
        {
        ...
        public CbenRole(int? tenantId, string displayName)
            : this()
        {
            TenantId = tenantId;
        ...
        /// <param name="displayName">Display name of the role</param>
        public CbenRole(int? tenantId, string name, string displayName)
