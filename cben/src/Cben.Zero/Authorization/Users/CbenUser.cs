...
namespace Cben.Authorization.Users
{
    ...
    /// Represents a user.
    /// </summary>
    public abstract class CbenUser<TUser> : CbenUserBase, IFullAudited<TUser>, IPassivable
        where TUser : CbenUser<TUser>
    {
        ...
        /// <summary>
        /// Is the <see cref="CbenUserBase.EmailAddress"/> confirmed.
        /// </summary>
        ...
        /// <summary>
        /// Is the <see cref="CbenUser{TUser}.PhoneNumber"/> confirmed.
        /// </summary>
