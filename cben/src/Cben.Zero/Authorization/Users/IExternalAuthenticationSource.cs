...
{
    /// <summary>
    /// Defines an authorization source to be used by <see cref="CbenUserManager{TRole,TUser}.LoginAsync"/> method.
    /// </summary>
        ...
        where TUser : CbenUser<TUser>
    {
        ...
        /// This source name is set to <see cref="CbenUser{TTenant,TUser}.AuthenticationSource"/>
