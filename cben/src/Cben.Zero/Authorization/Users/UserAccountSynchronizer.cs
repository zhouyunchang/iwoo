...
namespace Cben.Authorization.Users
{
    ...
    public class UserAccountSynchronizer :
        IEventHandler<EntityCreatedEventData<CbenUserBase>>,
        IEventHandler<EntityDeletedEventData<CbenUserBase>>,
        IEventHandler<EntityUpdatedEventData<CbenUserBase>>,
        ITransientDependency
    {
        ...
        /// </summary>
        [UnitOfWork]
        public virtual void HandleEvent(EntityCreatedEventData<CbenUserBase> eventData)
        {
        ...
        /// <param name="eventData"></param>
        [UnitOfWork]
        public virtual void HandleEvent(EntityUpdatedEventData<CbenUserBase> eventData)
        {
            using (_unitOfWorkManager.Current.SetTenantId(null))
            {
