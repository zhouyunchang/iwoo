...
namespace Cben.Localization
{
        ...
        ISingletonDependency
    {
        ...
        /// </summary>
        public const string CacheName = "CbenZeroLanguages";
        ...
        public virtual async Task AddAsync(ApplicationLanguage language)
        {
            ...
            {
                throw new CbenException("There is already a language with name = " + language.Name);
            }
        ...
        public virtual async Task RemoveAsync(int? tenantId, string languageName)
        {
            ...
            {
                throw new CbenException("Can not delete a host language from tenant!");
            }
        ...
        public virtual async Task UpdateAsync(int? tenantId, ApplicationLanguage language)
        {
            ...
            {
                throw new CbenException("Can not update a host language from tenant");
            }
        ...
        public void HandleEvent(EntityChangedEventData<ApplicationLanguage> eventData)
        {
            ...
            _cacheManager.GetCache("CbenLocalizationScripts").Clear();
        }
