...
namespace Cben.Authorization
{
    ...
    public static class PermissionCheckerExtensions
    {
        ...
        /// throws <see cref="CbenAuthorizationException"/> if not authorized.
        ...
        /// <exception cref="CbenAuthorizationException">Throws authorization exception if</exception>
        ...
        public static string L(IPermissionChecker permissionChecker, string name, string defaultValue)
        {
            ...
            {
                return localizationManager.Object.GetString(CbenConsts.LocalizationSourceName, name);
            }
        }
    }
}