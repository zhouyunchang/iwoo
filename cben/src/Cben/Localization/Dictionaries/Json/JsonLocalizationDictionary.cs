...
namespace Cben.Localization.Dictionaries.Json
{
    /// <summary>
    ...
    public class JsonLocalizationDictionary : LocalizationDictionary
    {
        ...
        public static JsonLocalizationDictionary BuildFromJsonString(string jsonString)
        {
            ...
            {
                throw new CbenException("Can not parse json string. " + ex.Message);
            }

            var cultureCode = jsonFile.Culture;
            if (string.IsNullOrEmpty(cultureCode))
            {
                throw new CbenException("Culture is empty in language json file.");
            }
            ...
            foreach (var item in jsonFile.Texts)
            {
                ...
                {
                    throw new CbenException("The key is empty in given json string.");
                }
