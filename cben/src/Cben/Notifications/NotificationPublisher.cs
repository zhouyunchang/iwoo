...
namespace Cben.Notifications
{
    ...
    /// </summary>
    public class NotificationPublisher : CbenServiceBase, INotificationPublisher, ITransientDependency
    {
            ...
            int?[] tenantIds = null)
        {
            ...
            if (tenantIds.IsNullOrEmpty() && userIds.IsNullOrEmpty())
            {
                tenantIds = new[] {CbenSession.TenantId};
            }
