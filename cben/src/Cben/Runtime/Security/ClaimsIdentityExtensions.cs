...
namespace Cben.Runtime.Security
{
    public static class ClaimsIdentityExtensions
    {
        ...
        public static int? GetTenantId(this IIdentity identity)
        {
            ...
            var tenantIdOrNull = claimsIdentity?.Claims?.FirstOrDefault(c => c.Type == CbenClaimTypes.TenantId);
        ...
        public static long? GetImpersonatorUserId(this IIdentity identity)
        {
            ...
            var userIdOrNull = claimsIdentity?.Claims?.FirstOrDefault(c => c.Type == CbenClaimTypes.ImpersonatorUserId);
            if (userIdOrNull == null)
            {
                return null;
            }
        ...
        public static int? GetImpersonatorTenantId(this IIdentity identity)
        {
            ...
            var tenantIdOrNull = claimsIdentity?.Claims?.FirstOrDefault(c => c.Type == CbenClaimTypes.ImpersonatorTenantId);
            if (tenantIdOrNull == null)
            {
                return null;
            }
